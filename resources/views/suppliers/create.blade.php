                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="small font-italic text-muted mb-2">JPG or PNG tidak boleh lebih dari 1 MB</div>
                                ...
                                <div class="row row-cards">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type">
                                            <option selected="" disabled="">Pilih tipe supplier:</option>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <x-input name="account_holder" label="Nama pengguna rekening"/>
                                    </div>
